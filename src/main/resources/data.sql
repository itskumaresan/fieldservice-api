...
values (20001, 'Y', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 1, 'Event1', 'CRITICAL', 'CRITICAL', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 5, 'ASSIGNED', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'));
insert into events(ID, ACTIVE, CREATED, END_DATE, ZONE_ID, NAME, PRIORITY, SEVERITY, START_DATE, NUMBER_OF_WORKERS_REQUIRED, STATUS, UPDATED) 
values (20002, 'Y', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 2, 'Event2', 'HIGH', 'MODERATE', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 2, 'ASSIGNED', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'));
insert into events(ID, ACTIVE, CREATED, END_DATE, ZONE_ID, NAME, PRIORITY, SEVERITY, START_DATE, NUMBER_OF_WORKERS_REQUIRED, STATUS, UPDATED) 
values (20003, 'Y', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 3, 'Event3', 'LOW', 'LOW', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 1, 'ASSIGNED', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'));
insert into events(ID, ACTIVE, CREATED, END_DATE, ZONE_ID, NAME, PRIORITY, SEVERITY, START_DATE, NUMBER_OF_WORKERS_REQUIRED, STATUS, UPDATED) 
values (20004, 'Y', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 4, 'Event4', 'CRITICAL', 'CRITICAL', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'), 10, 'UNASSIGNED', PARSEDATETIME('24 Apr 2019','dd MMM yyyy','en'));
insert into events(ID, ACTIVE, CREATED, END_DATE, ZONE_ID, NAME, PRIORITY, SEVERITY, START_DATE, NUMBER_OF_WORKERS_REQUIRED, STATUS, UPDATED) 
